      ...
      <div className='bg-black text-white p-12'>
        ...
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='border-t border-gray-800 pt-8 mb-16'>
            ...
            <h3 className='text-lg font-light mt-8 mb-4 text-amber-200'>
              {language === 'de' ? 'B. Besondere Hinweise' : 'B. Special notes'}
            </h3>
            <p className='text-gray-300 font-light leading-relaxed'>
              {language === 'de'
          ...
          <div className='border-t border-gray-800 pt-8 mb-16'>
            ...
            <p className='text-lg font-medium mt-6 mb-4 text-amber-200'>
              {language === 'de'
            ...
            <p className='text-gray-300 font-light leading-relaxed mt-4'>
              {language === 'de'
                ...
                : 'Once the package has arrived at the warehouse and has been checked, we will make the refund.'}
            </p>
            <p className='text-gray-300 font-light leading-relaxed mt-4'>
              {language === 'de'
